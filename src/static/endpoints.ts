...
export const mainRoute = {
  ...
  ADMIN_DASHBOARD_DELETE_LOCATION: "/admin-dashboard/delete-location",
  ADMIN_DASHBOARD_DELETE_PACKAGE: "/admin-dashboard/delete-package",
  ADMIN_DASHBOARD_DELETE_RESTAURANT: "/admin-dashboard/delete-restaurant",
  ADMIN_DASHBOARD_DELETE_MENU_TYPE: "/admin-dashboard/delete-menu-type",
  ADMIN_DASHBOARD_DELETE_MENU: "/admin-dashboard/delete-menu",
  ADMIN_DASHBOARD_DELETE_CATEGORY: "/admin-dashboard/delete-category",
